...
import 'package:mobile/views/biometric/after_home_page_biometric/after_home_page_biometry_screen_first_ad.dart';
  ...
  Route ongenerateRoute(RouteSettings settings) {
    ...
    switch (settings.name) {
      ...
      case NavigationConst.AFTER_HOME_PAGE_BIOMETRIC_FIRST_AD:
        return normalNavigate(AfterHomePageBiometricFirstAd());
