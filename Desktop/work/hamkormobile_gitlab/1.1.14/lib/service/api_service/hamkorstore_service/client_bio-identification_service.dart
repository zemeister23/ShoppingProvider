...
class ClientBioIdentificationService {
  static final ClientBioIdentificationService _instance =
      ClientBioIdentificationService._init();
  static ClientBioIdentificationService get instance => _instance;
  Future<BioIdentificationModel> postClientBioIdentification(
    String image,
  ) async {
    var _data = {
      "doc_type": 1,
      "photo": {"front": "data:image/png;base64," + image}
    };
    try {
      final response = await DioClient.instance
          .post('${Endpoints.baseUrl}${Endpoints.clientBioIdentification}',
              data: _data,
              options: Options(
