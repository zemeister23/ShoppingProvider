...
class AfterRazvilkaBiometryScreen extends StatefulWidget {
  AfterRazvilkaBiometryScreen({Key? key}) : super(key: key);

  @override
  State<AfterRazvilkaBiometryScreen> createState() => _AfterRazvilkaBiometryScreenState();
}

class _AfterRazvilkaBiometryScreenState extends State<AfterRazvilkaBiometryScreen> {
  @override
  ...
  Widget build(BuildContext context) {
    ...
    return BaseView(
      viewModal: AfterRazvilkaBiometryScreen,
                ...
                children: <Widget>[
                                  ...
                                  children: <Widget>[
                                    ...
                                    SizedBox(
                                      ...
                                      child: TextFormField(
                                        ...
                                        controller: myProvider.seriyesController,
                                        onChanged: (value) =>
                                  ...
                                  children: <Widget>[
                                    ...
                                    SizedBox(
                                      ...
                                      child: TextFormField(
                                        ...
                                        onChanged: (value) =>
                                            myProvider.changeSeriesNumber(value),
                                        inputFormatters: [
                            ...
                            children: <Widget>[
                              ...
                              TextFormField(
                                ...
                                decoration: InputDecoration(
                                  ...
                                  focusedBorder: OutlineInputBorder(
                                    borderRadius:
                                        BorderRadius.circular(context.h * 0.015),
                                    borderSide: BorderSide(
                                      color: context.biometricPrStream.isErorColor ? ColorConst.instance.kErrorColor :  ColorConst.instance.kPrimaryColor,
                                      width: 0.5,
                                    ),
                                  ),
                                  enabledBorder: OutlineInputBorder(
                  ...
                  GradientButton(
                    ...
                    onPressed: () {
                     ...
                     //   Navigator.push(context, MaterialPageRoute(builder:(_)=> AfterRazvilkaBiometricFirst(afterBioScreen: true,)));
