...
class BankomatsScreen extends StatelessWidget {
  ...
  static Future bankomats(BuildContext context, List<bancomate.Datum> data,int i) {
              ...
              children: [
                Positioned(
                  ...
                  child: SvgPicture.asset(
                    ImageConst.instance.toSvg(MapProvider.cardLogo(data[i].type.toString().split("Type.")[1].toString())),
                    width: 90.w,
                    height: 90.w,
                  ),
                ),
