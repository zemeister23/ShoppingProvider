...
class UzCardScreen extends StatelessWidget {
  const UzCardScreen({Key? key}) : super(key: key);
  ...
  static Future uzCard(BuildContext context, List<bancomate.Datum> data,int i) {
              ...
              children: [
                Positioned(
                  ...
                  child: SvgPicture.asset(
                    ImageConst.instance.toSvg("uzcard_rectangle"),
                    width: 90.w,
                    height: 90.w,
                  ),
                ),
