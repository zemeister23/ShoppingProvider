      ...
      try {
        ...
        if (e is DioError) {
          if (e.response!.statusCode == 500) {
            ErrorMessage.instance.erorAddCardAlert(
                e.response!.data["error_code"].toString(), context);
          }
  ...
  postPhoneNumberSendAgain(
    ...
    try {
      final PhoneRegistation response =
          await RegistrationApi.instance.postNumber(_number, value, context);
      GetStorageService.instance.box
