...
class AddCardProvider extends ChangeNotifier {
      ...
      if (isValid) {
        ...
        if (_data.errorCode == 0) {
          ...
          if (!isSendAgain) {
            ...
            myProvider.erorText = '';
            myProvider.erorText = '';
            if (myProvider.seconds == 00 && myProvider.seconds != 0) {
              ErrorMessage.instance.translationsEror(111, context,
                  onTap: () async {
                await context.addCardPr
  ...
  getProductStore(BuildContext context) {}
}
