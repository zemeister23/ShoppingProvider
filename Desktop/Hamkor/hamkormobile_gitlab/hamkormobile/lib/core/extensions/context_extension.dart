...
extension SizedContext on BuildContext {
  ...
  bool get isLandscape => mq.orientation == Orientation;
  ...
  SmsProvider get smsPrStream => this.watch<SmsProvider>();
  ...
  BiometricProvider get biometricPrStream => this.watch<BiometricProvider>();
    WebViewProvider get webViewPr =>   Provider.of<WebViewProvider>(this, listen: false);
    WebViewProvider get webViewPrSream => this.watch<WebViewProvider>();
 CheckPinCodeProvider get checkPinProvider =>   Provider.of<CheckPinCodeProvider>(this, listen: false);
    CheckPinCodeProvider get checkPinProviderStream => this.watch<CheckPinCodeProvider>();
