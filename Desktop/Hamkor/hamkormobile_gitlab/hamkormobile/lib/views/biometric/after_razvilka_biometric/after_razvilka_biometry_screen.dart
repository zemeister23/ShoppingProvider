...
class AfterRazvilkaBiometryScreen extends StatefulWidget {
  ...
  @override
  State<AfterRazvilkaBiometryScreen> createState() =>
      _AfterRazvilkaBiometryScreenState();
}

class _AfterRazvilkaBiometryScreenState
    extends State<AfterRazvilkaBiometryScreen> {
  @override
                    ...
                    onPressed: () {
                      if (myProvider.isValid) {
                        ...
                        NavigationService.instance.pushNamed(
                          routeName:
                              NavigationConst.AFTER_RAZVILKA_ABIOMETRIC_FIRST,
                        );
                      }
                    },
                  ),
