...
class AfterWebViewBiometricCameraAndroid extends StatefulWidget {
  ...
  @override
  _AfterWebViewBiometricCameraAndroidState createState() =>
      _AfterWebViewBiometricCameraAndroidState();
}

class _AfterWebViewBiometricCameraAndroidState
    extends State<AfterWebViewBiometricCameraAndroid> {
...
class _CameraViewState extends State<CameraView> {
                  ...
                  Future.delayed(
                    ...
                    _controller!.stopImageStream().then((_) {
                      ...
                      Navigator.pushAndRemoveUntil(
                        context,
                        MaterialPageRoute(
                          builder: (_) => AfterWebViewBiometricLast(
  ...
  Future _processCameraImage(CameraImage image) async {
    ...
    //                 context,
    //                 MaterialPageRoute(
    //                   builder: (_) => AfterHomePageBiometricLast(
...
class FaceDetectorPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    if (myfaces.isEmpty) {
      ...
      if (isSmile) {
        if (myfaces[0].smilingProbability! < 0.1) {
          paintColor = Colors.red;
        }
      }
