...
class AfterHomePageBiometricCameraAndroid extends StatefulWidget {
  ...
  @override
  _AfterHomePageBiometricCameraAndroidState createState() =>
      _AfterHomePageBiometricCameraAndroidState();
}

class _AfterHomePageBiometricCameraAndroidState
...
class _CameraViewState extends State<CameraView> {
  ...
  Widget _liveFeedBody() {
    ...
    scale = 1.sw / 1.sh / _controller!.value.aspectRatio;
