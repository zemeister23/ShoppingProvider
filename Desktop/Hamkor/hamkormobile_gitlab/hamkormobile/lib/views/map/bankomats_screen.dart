...
class BankomatsScreen extends StatelessWidget {
  const BankomatsScreen({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("Bankomats Screen Moved"),
      ),
    );
  }

  static Future bankomats(
      BuildContext context, List<bancomate.Datum> data, int i) {
              ...
              children: [
                Positioned(
                  ...
                  child: SvgPicture.asset(
                    ImageConst.instance.toSvg(MapProvider.cardLogo(
                        data[i].type.toString().split("Type.")[1].toString())),
                    width: 90.w,
                    height: 90.w,
                  ),
                ),
                        ...
                        children: <Widget>[
                          ...
                          Column(
                            ...
                            children: <Widget>[
                              ...
                              Container(height: context.h * 0.0075),
                              Text(
