...
import 'package:mobile/widgets/dialogs/intirnet_eror.dart';
import 'package:mobile/widgets/dialogs/succes_dialog.dart';
...
class _RegistrationScreenState extends BaseState<RegistrationScreen> {
  ...
  Future init() async {
    String? phoneVersion = await DeviceInfoApi.getPhoneVersion();
    ...
    setState(() {
      ...
      // 
      // 
      _storage.write(GetStorageService.instance.sdkInt, phoneVersion);
